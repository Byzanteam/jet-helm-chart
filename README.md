...
**Please note: This repository is currently unmaintained by a team of developers at Byzanteam. It is now maintained by the [charts/jet-helm-chart](https://github.com/Byzanteam/charts/tree/main/charts/jet-helm-chart).**
...
| nameOverride | string | `""` |  |
| existingJetSecret | string | `"jet-env-secret"` | 已创建的 secret 名称 |
